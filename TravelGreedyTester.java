...
public class TravelGreedyTester
{
        ...
        if (userIn.equalsIgnoreCase("quit")) //if user typed quit, stops program
          break;
              ...
              try
              {
                ...
                System.out.println("\n***TSP Greedy Output for " + userIn + "***\n");
                PWOut.println("\n***TSP Greedy Output for " + userIn + "***\n");

				//creating new TravelGreedy object and calling timedSolve Method
                TravelGreedy tG = new TravelGreedy(numOfVerts, edges, PWOut);
                tG.timedSolve();
